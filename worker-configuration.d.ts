// CHECKED IN ON PURPOSE. Generated by `npm run cf-typegen` (wrangler types),
// but committed because tsconfig.worker.json has `"types": []` and takes every
// Workers runtime global from this file. Without it in the repo a fresh clone
// cannot typecheck the worker at all — CI has no Request, Response, URL,
// WebSocket or crypto. Regenerate and commit after changing wrangler.jsonc.
// DO NOT EDIT — checked in on purpose.
/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59ecca9e08de507805e9d3c66e6b2349)
// Runtime types generated with workerd@1.20260722.1 2025-05-05 nodejs_compat
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "GameRoom" | "RateLimiter";
	}
